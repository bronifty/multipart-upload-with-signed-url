...
const CreateNote = (props) => {
    ...
    return (<PageContainer header={<HomeButton />}>
      <form onSubmit={handleSubmit}>
        {errorMsg && <Alert variant="danger">{errorMsg}</Alert>}
        <Form.Group controlId="content">
          <Form.Label>Note Content</Form.Label>
          <Form.Control as="textarea" placeholder={isRecording ? "Speak Now" : "Enter Note content"} onChange={(e) => {
        ...
        <Form.Group>
          <RecordAudioButton disabled={isPlaying} isRecording={isRecording} setIsRecording={setIsRecording} setNoteContent={setNoteContent}/>
          <PlayAudioButton disabled={isRecording} isPlaying={isPlaying} setIsPlaying={setIsPlaying} noteContent={noteContent}/>
        </Form.Group>
