...
const RecordAudioButton = (props) => {
    ...
    const streamAudioToWebSocket = async (audioDataIterator) => {
    ...
    return (<>
      ...
      <Button variant={isRecording ? "primary" : "outline-secondary"} size="sm" onClick={toggleTrascription} disabled={disabled}>
