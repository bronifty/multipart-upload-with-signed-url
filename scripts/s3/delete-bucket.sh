...
echo "aws s3api delete-bucket --profile $PROFILE_NAME --bucket $BUCKET_NAME --region $REGION"
aws s3api delete-bucket --profile $PROFILE_NAME --bucket $BUCKET_NAME --region $REGION
