...
echo "aws cloudformation describe-stack-events --stack-name $STACK_NAME --profile $PROFILE_NAME"
aws cloudformation describe-stack-events --stack-name $STACK_NAME --profile $PROFILE_NAME
